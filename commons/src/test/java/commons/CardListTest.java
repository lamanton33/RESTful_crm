...
class CardListTest {
    ...
    private void setup() {
        ...
        @Test
    void testEquals() {
            CardList cardListA = new CardList("cardListTitle",new ArrayList<>());
            CardList cardListB = new CardList("cardListTitle", new ArrayList<>());
            CardList cardListC = new CardList("cardListTitle", new ArrayList<>());
            CardList cardListD = new CardList("cardListTitle", new ArrayList<>());
            CardList cardListE = new CardList("cardListTitle", new ArrayList<>());
    ...
    void testToString() {
        ...
        String string ="CardList{cardListID=1, cardListTitle='cardListTitle', cardList=[Card{cardID=1, " +
                "cardTitle='', cardDescription='', taskList=[], tagList=[]}, Card{cardID=2, cardTitle='cardTitle', " +
                "cardDescription='cardDescription', taskList=[], tagList=[]}, Card{cardID=3, cardTitle='', " +
                "cardDescription='', taskList=[Task{taskID=1, taskTitle='', isCompleted=false}, Task{taskID=2, " +
