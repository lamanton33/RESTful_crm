...
class CardListTest {
    ...
    void testToString() {
        ...
        String string = "CardList{cardListID=1, cardListTitle='cardListTitle', " +
                "cardList=[Card{cardID=1, cardTitle='', cardDescription='', taskList=[], tagList=[]}, " +
                "Card{cardID=2, cardTitle='cardTitle', cardDescription='cardDescription', taskList=[], tagList=[]}, " +
                "Card{cardID=3, cardTitle='', cardDescription='', taskList=[Task{taskID=1, taskTitle='', " +
                "isCompleted=false}, Task{taskID=2, taskTitle='taskUncompleted', isCompleted=false}, " +
                "Task{taskID=3, taskTitle='taskCompleted', isCompleted=true}], tagList=[]}, " +
                "Card{cardID=4, cardTitle='', cardDescription='', taskList=[], " +
                ...
                "isCompleted=true}], tagList=[Tag{tagID=1, tagTitle='', tagColor=''}, " +
